...
var stream2 = fs.createReadStream('./csv/top1100.csv');
var stream3 = fs.createReadStream('./csv/top5000.csv');
...
function writeFile() {
        csv
        .fromStream(stream3, {headers: ["position", "artist", "song", "year", "raw_total", "raw_usa", "raw_uk", "raw_eur", "raw_row"]})
